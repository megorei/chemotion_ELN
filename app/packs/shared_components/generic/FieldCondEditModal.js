...
import FieldSelect from '/app/packs/shared_components/generic/FieldSelect';
import LayerSelect from '/app/packs/shared_components/generic/LayerSelect';
...
export default class FieldCondEditModal extends Component {
  ...
  render() {
    const { showModal, fnClose, layer, field } = this.props;
