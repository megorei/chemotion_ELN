...
module CollectionHelpers
  ...
  def detail_level_for_collection(id, is_sync = false)
    ...
    )&.symbolize_keys
    {
      ...
      sequence_based_macromolecule_sample_detail_level: 0,
    }.merge(dl || {})
  end
  ...
  def set_var(c_id = params[:collection_id], is_sync = params[:is_sync])
    ...
    @dl = {
      ...
      sequence_based_macromolecule_sample_detail_level: 10,
    }
    ...
    @dl_mm = @dl[:sequence_based_macromolecule_sample_detail_level]
  end
end
