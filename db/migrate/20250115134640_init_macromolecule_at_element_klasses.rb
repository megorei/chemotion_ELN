class InitMacromoleculeAtElementKlasses < ActiveRecord::Migration[6.1]
  def up
    klass = Labimotion::ElementKlass.where(name: 'macromolecule').first
    if klass.nil?
      klass = Labimotion::ElementKlass.create(name: 'macromolecule')
