class CreateMacromoleculeSample < ActiveRecord::Migration[6.1]
  def change
    create_table :macromolecule_samples do |t|
      ...
      t.belongs_to :macromolecule, foreign_key: true, index: true
      t.timestamps
    end
  end
end
